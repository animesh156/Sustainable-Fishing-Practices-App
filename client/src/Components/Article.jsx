...
Overfishing is the greatest threat to the biodiversity of the world’s oceans. Information published for U.S. fisheries can serve as an example of how large the problem is. In the United States, Congress requires the National Marine Fisheries Service (NMFS) to make regular reports. The organization analyzes the status of the major fishes within the country’s exclusive economic zone, or EEZ. </p>
